...
const NinethGradeScreen = () => {
  return (
    <Box safeArea flex={1} bg='danger.100'>

      {/* header section */}
      <Center >
        <Text fontSize="2xl" fontWeight="bold" color="purple.900" mt={20}>
          Nineth Grade Quiz Test
        </Text>
      </Center>
...
export default NinethGradeScreen;
