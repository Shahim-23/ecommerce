...
const SeventhGradeScreen = () => {
  return (
    <Box safeArea flex={1} bg='emerald.100'>

      {/* header section */}
      <Center >
        <Text fontSize="2xl" fontWeight="bold" color="black" mt={20}>
           Seventh Grade Quiz Test
        </Text>
      </Center>
...
export default SeventhGradeScreen;
